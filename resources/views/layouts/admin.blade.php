...
@php
    $menu = [
        'Nav' => [
            ['icon' => 'fa-solid fa-gauge', 'label' => 'Dashboard', 'route' => 'admin.dashboard'],
            ['icon' => 'fa-solid fa-users', 'label' => 'Users', 'route' => 'admin.users.index'],
        ],
        'Settings' => [
            ['icon' => 'fa-solid fa-gear', 'label' => 'Config', 'route' => 'admin.settings'],
        ],
    ];
@endphp
                        ...
                        @foreach($items as $item)
                            <a href="#"
                                @class([
                                    ...
                                    'bg-slate-700 text-white' => request()->routeIs($item['route'] . '*'),
                                    'text-gray-100 hover:bg-slate-700' => !request()->routeIs($item['route'] . '*'),
                                ])>
        ...
        <main class="flex flex-col relative lg:left-64 lg:w-[calc(100%-16rem)] min-h-screen bg-slate-100">
            ...
            <header id="header" class="h-12 text-xl lg:text-base flex flex-row bg-white shadow-sm">
                ...
                <div class="flex flex-row ml-auto" x-data="{userMenuOpen: false}">
                    <div class="relative">
                        <button @click="userMenuOpen = !userMenuOpen" class="flex flex-row items-center px-4 py-2 text-gray-800 h-full">
                            <img class="w-8 h-8 rounded-full bg-gray-300" src="https://api.dicebear.com/7.x/adventurer/svg?seed=test" alt="User avatar">
                        ...
                        >
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white transition-colors duration-200">
            ...
            <footer id="footer" class="text-slate-400 text-xs px-3 py-1.5 border-t border-slate-200 mt-2">
                Copyright &copy; 2024 Alexandre. Tous droits réservés.
            </footer>
        </main>
