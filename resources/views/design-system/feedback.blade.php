        ...
        <div class="max-w-5xl mx-auto px-8 py-12 flex flex-col gap-16">
            ...
            <section class="flex flex-col divide-y divide-gray-100 rounded-2xl border border-gray-100 bg-white shadow-xs overflow-hidden">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Status and category labels</p>
                </div>
                ...
                <div class="flex items-start gap-8 px-6 py-8">
                    <div class="flex flex-col gap-0.5 w-56 shrink-0">
                        ...
                        <span class="text-xs text-gray-400">The 6 available colors</span>
                    </div>
                ...
                <div class="flex items-start gap-8 px-6 py-8">
                    <div class="flex flex-col gap-0.5 w-56 shrink-0">
                        ...
                        <span class="text-xs text-gray-400">Status indicator with colored dot</span>
                    </div>
                    <div class="flex flex-wrap gap-2">
            ...
            <section class="flex flex-col divide-y divide-gray-100 rounded-2xl border border-gray-100 bg-white shadow-xs overflow-hidden">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Contextual feedback messages within the page</p>
                </div>
                ...
                <div class="flex items-start gap-8 px-6 py-8">
                    <div class="flex flex-col gap-0.5 w-56 shrink-0">
                        ...
                        <span class="text-xs text-gray-400">Title + description</span>
                    </div>
                    <div class="flex flex-col gap-3 flex-1">
                ...
                <div class="flex items-start gap-8 px-6 py-8">
                    <div class="flex flex-col gap-0.5 w-56 shrink-0">
                        ...
                        <span class="text-xs text-gray-400">Closable by user</span>
                    </div>
                    <div class="flex flex-col gap-3 flex-1">
