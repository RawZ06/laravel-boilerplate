    ...
    <div class="relative">
        <div class="relative">
            ...
            <input
                ...
                class="w-full pl-9 pr-9 py-2.5 rounded-xl border text-sm transition-all duration-150 shadow-xs outline-none
                    {{ $error ? 'border-rose-300 bg-rose-50 focus:ring-2 focus:ring-rose-300 focus:border-rose-400' : 'border-gray-200 bg-white focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 hover:border-gray-300' }}
        ...
        <div class="relative">
            <div
                ...
                class="absolute top-1.5 left-0 right-0 z-50 rounded-xl border border-gray-100 bg-white shadow-lg overflow-hidden"
                style="display:none"
            >
            ...
            <div
                ...
                x-transition:enter-start="opacity-0 translate-y-1"
                x-transition:enter-end="opacity-100 translate-y-0"
                class="absolute top-1.5 left-0 right-0 z-50 rounded-xl border border-gray-100 bg-white shadow-lg px-4 py-3"
                style="display:none"
            >
