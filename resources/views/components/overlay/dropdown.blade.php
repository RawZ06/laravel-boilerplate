    ...
    <template x-teleport="body">
        <div
            ...
            :style="{
                ...
                right: align === 'right' ? (document.documentElement.scrollWidth - x) + 'px' : 'auto',
                transform: align === 'center' ? `translateX(calc(${x}px - 50%))` : 'none',
            }"
            class="z-[9999] min-w-48 bg-white border border-gray-100 rounded-xl shadow-lg overflow-hidden"
            x-cloak
